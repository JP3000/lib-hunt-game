...
const LEVELS_BY_LOCALE: Record<Locale, LevelConfig[]> = {
  "zh-Hant": [
    ...
    },
    {
      ...
      question:
        "這套標註為 1/F B4「Macau Collection [LIB USE ONLY]」的《全海圖註》，究竟在哪個專區？",
      options: [
        { id: "a", label: "澳門坊" },
        { id: "b", label: "澳門叢書" },
        { id: "c", label: "古籍館" },
    ...
    },
    {
      ...
      story: `你來到資訊素養室——這裡是學會分辨「真理」與「偽證」的地方。在 AI 橫行的年代，什麼才是真正可信的「信」？你將五張卡牌「仁、義、禮、知、信」按順序排列，拼合成一個完整的五角形。卡牌背面的文字在燈下連成一段話：「福松影沒，非為金銀；九章再開，始於澳大。校訓之基，五德同輝。」你終於明白：鄭芝龍當年委託福松丸運送的，並非黃金珠寶，而是能改變中西文明對話走向的鑰匙。四百年前沉入西石的聖物，隨澳門大學的興建而重見天日，化作了這座學府的基石——「仁、義、禮、知、信」也從古老的手稿，化作了澳大人代代相傳的校訓。真正的寶藏，不在地底，而在這座圖書館的每一排書架、每一本書，以及你對真理的不懈追求之中。`,
  ...
  en: [
    ...
    },
    {
      ...
      question:
        "Marked as 1/F B4 'Macau Collection [LIB USE ONLY],' in which special area is the Quan Hai Tu Zhu actually located?",
      options: [
        { id: "a", label: "Macau Corner (澳門坊)" },
        { id: "b", label: "Macau Series (澳門叢書)" },
        { id: "c", label: "Rare Book Room (古籍館)" },
        { id: "d", label: "Archives (檔案館)" },
      ],
      correctOptionIds: ["a"],
      qrAnswer: "L07-STACK-KEY",
